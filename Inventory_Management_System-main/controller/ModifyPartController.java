...
/**
 * Controller class provides the logic to for the modify part screen corresponding with the view of the modify part application
 *
 ...
 * @throws IOException 
 */
    @FXML public void addPartCancelButtonAction(ActionEvent event) throws IOException {
    ...
    /**
     * This allows the user to add a part to the inventory system by replacing it in the inventory and then will return to the main screen.
    ...
    /**
     * initializes the controller with the part selected fields selected in the main screen.
     * @param url
     * @param rb 
     */
    @Override
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if(selectedPart instanceof InHouse){
            ...
            addPartMachineIDCompanyLabel.setText("Machine ID");
            addPartIDText.setText(String.valueOf(((InHouse) selectedPart).getMachineId()));
        }
        if(selectedPart instanceof Outsourced){
            partOutsourcedRadio.setSelected(true);
            addPartMachineIDCompanyLabel.setText("Company Name");
            addPartIDText.setText(String.valueOf(((Outsourced) selectedPart).getCompanyName()));
        }
        addPartIDText.setText(String.valueOf(selectedPart.getId()));
        addPartNameText.setText(selectedPart.getName());
        addPartInvText.setText(String.valueOf(selectedPart.getStock()));
        addPartPriceText.setText(String.valueOf(selectedPart.getPrice()));
        addPartMinText.setText(String.valueOf(selectedPart.getMin()));
        addPartMaxText.setText(String.valueOf(selectedPart.getMax()));
    }
